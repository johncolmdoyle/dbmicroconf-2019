...
module "postgres_sg" {
  ...
  ingress_cidr_blocks = ["${var.vpc_public_subnet_cidr_blocks[0]}", "${var.vpc_public_subnet_cidr_blocks[1]}", "${var.vpc_public_subnet_cidr_blocks[2]}"]
