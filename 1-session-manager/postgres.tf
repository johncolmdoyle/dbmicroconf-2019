...
module "db" {
  ...
  identifier = "microconf-session-mgmr"
...
module "postgres_sg" {
  ...
  ingress_cidr_blocks = ["${var.vpc_private_subnet_cidr_blocks[0]}", "${var.vpc_private_subnet_cidr_blocks[1]}", "${var.vpc_private_subnet_cidr_blocks[2]}"]
